...
Link:https://pan.baidu.com/s/1t7nSYaspYCsQy5SCSDzXqg?pwd=1234
Code:1234
How to use this:(take IP for example)
First, we execute the BandFusiondemo.m script to obtain the band-grouping fusion results saved as img2.mat. 
Then, we run IP_train.py to generate the final classification map and accuracy values.
